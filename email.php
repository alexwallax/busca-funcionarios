...
$result = "SELECT * FROM FUNCIONARIOS WHERE NOME_FUNC OR EMAIL_FUNC) or departamento_func LIKE'%$busca%' LIMIT 15";
...
if ($resultado_busca->num_rows > 0) {
    ...
    while($rows_busca = mysqli_fetch_array($resultado_busca)) {  
        ...
        $result_tot = $result_tot . "<tr><td>" . $rows_busca['NOME_FUNC'] . " <td> - </td> " ."</td><td>" . $rows_busca['EMAIL_FUNC'] . "</td></tr>";
